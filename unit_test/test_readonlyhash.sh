...
run_test "$ROH_BIN vi < $fpath" "0" "$(escape_expected "DB_SQL:.*roh.sqlite3] -- initialized")"
...
run_test "$ROH_COPY -n --rebase blammy/cheeze:$TARGET blammy/cheeze/Fotos\ \[space\]/1999" "0" "$(escape_expected "DRY-RUN: copied [blammy/cheeze/Fotos [space]/1999/.roh.git] to [_target~/Fotos [space]/1999/.] -- existing")"
...
# - if REBASE_TARGET ends NOT in .ro
run_test "$ROH_COPY --dry-run --rebase blammy/cheeze:$TARGET blammy/cheeze/2002.ro" "0" "$(escape_expected "DRY-RUN: copied [blammy/cheeze/2002.ro/.roh.git] to [_target~/2002/.] -- existing")"
...
run_test "$ROH_COPY --dry-run --rebase blammy/cheeze:$TARGET blammy/cheeze/2002.ro" "0" "$(escape_expected "DRY-RUN: copied [blammy/cheeze/2002.ro/.roh.git] to [$TARGET/2002.ro/.] -- existing")"
...
run_test "$ROH_COPY --dry-run --rebase blammy/cheeze:$TARGET blammy/cheeze/2002" "0" "$(escape_expected "DRY-RUN: copied [blammy/cheeze/2002/.roh.git] to [_target~/2002.ro/.] -- existing")"
...
# backup
run_test "$ROH_COPY --dry-run --rebase blammy/cheeze:backup-target blammy/cheeze/Fotos\ \[space\]/1999" "0" "$(escape_expected "DRY-RUN: copied [blammy/cheeze/Fotos [space]/1999/.roh.git] to [backup-target/Fotos [space]/1999/.] -- NEW!")"
