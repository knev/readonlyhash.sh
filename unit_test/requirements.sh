...
rm "four.txt"
run_test "$ROH_SCRIPT verify" "1" "$(escape_expected "ERROR: -- [ab929fcd5594037960792ea0b98caf5fdaf6b60645e4ef248c28db74260f393e]: [./.roh.git/four.txt.sha256].* [./four.txt] -- NO corresponding file")"

# remove orphaned hashes (in bulk)
run_test "$ROH_SCRIPT show" "1" "$(escape_expected "ERROR: -- [ab929fcd5594037960792ea0b98caf5fdaf6b60645e4ef248c28db74260f393e]: [./.roh.git/four.txt.sha256].*[./four.txt] -- NO corresponding file")"
...
run_test "$ROH_SCRIPT verify" "1" "$(escape_expected "WARN: -- [ac169f9fb7cb48d431466d7b3bf2dc3e1d2e7ad6630f6b767a1ac1801c496b35]: [./seven.txt] -- NO hash found.*ERROR: -- [ac169f9fb7cb48d431466d7b3bf2dc3e1d2e7ad6630f6b767a1ac1801c496b35]: [./.roh.git/five.txt.sha256].*[./five.txt] -- NO corresponding file")"
...
#TMP
mv "$ROH_DIR/five.txt.sha256" "$ROH_DIR/seven.txt.sha256"
...
run_test "$ROH_SCRIPT verify" "0" "$(escape_expected "WARN: -- [65cb0ca932c81498259bb87f57c982cef5df83a8b8faf169121b7df3af40b477]: [./subdir/this_does_not_exist/this_does.txt] -- NO hash found")"
...
run_test "$ROH_SCRIPT verify" "1" "$(escape_expected "ERROR: -- [65cb0ca932c81498259bb87f57c982cef5df83a8b8faf169121b7df3af40b477]: [./.roh.git/subdir/this_does_not_exist/this_does.txt.sha256].*[./subdir/this_does_not_exist/this_does.txt] -- NO corresponding file")"
